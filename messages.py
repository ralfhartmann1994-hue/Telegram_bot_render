# =================
# messages.py (محسن مع رسائل مضحكة ورسائل خاصة بكل فئة)
# =================
import random
import time
